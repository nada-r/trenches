...
function createPower(data) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, prisma.power.create({
                        data: data,
                    })];
                case 1:
                    power = _a.sent();
...
function createCard(data, powerId, UserId) {
    return __awaiter(this, void 0, void 0, function () {
        var card;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, prisma.card.create({
                        data: __assign(__assign({}, data), { power: {
                                connect: { id: powerId }
                            }, owner: {
                                connect: { id: UserId }
                            } })
    ...
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                return [4 /*yield*/, createCard({ name: "rug", price: 3, image: "src/image.com" }, 1, 1)];
                case 1:
                    // // Show connection status
                    // const isConnected = await prisma.$connect().then(() => true).catch(() => false);
                    // console.log("!Prisma connection status:", isConnected ? "Connected" : "Not Connected");
...
main().catch(function (e) { return console.error("!Unhandled error in main:", e); });
