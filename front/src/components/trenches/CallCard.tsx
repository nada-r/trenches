...
import CallOpenTime from '@/components/trenches/CallOpenTime';
  ...
  return (
    <div className="flex items-center bg-neutral-900 rounded p-3">
      ...
      <div className="flex flex-col ml-3 flex-1 overflow-hidden">
        <div className="flex flex-row grow items-center border-b pb-2 border-gray-700">
          <div className="flex flex-col grow gap-y-2 overflow-hidden">
            <div className="flex flex-row justify-between items-start">
              <div className="flex flex-row">
                <div className="!p-0 !m-0 !h-auto relative flex grow-0 gap-x-1 overflow-hidden">
                ...
                <div className="!p-0 !m-0 relative !ml-1 flex grow-0 !h-[12px] z-10 hover:cursor-pointer">
                  <CopyToClipboard
              ...
              <div className="text-gray-400 text-xs text-right font-medium ml-1">
                <CallOpenTime date={call.createdAt} />
              </div>
            </div>
